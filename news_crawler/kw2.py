...
seg_list = jieba.lcut(doc, cut_all=False) # cut_all 參數為 True ->全模式，預設為 False ->精確模式
...
keywords = kw_model.extract_keywords(seg_list,keyphrase_ngram_range=(1, 2),use_mmr=True, diversity=0.6,highlight=False)
print(keywords) # dtype=list
print(type(keywords))
